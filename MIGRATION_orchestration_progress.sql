-- Migration script for tender_orchestration_progress table
-- Run this in Supabase SQL Editor or via psql

-- Create the tender_orchestration_progress table
...
DROP POLICY IF EXISTS "Users can view own orchestration progress" ON tender_orchestration_progress;
DROP POLICY IF EXISTS "Users can create own orchestration progress" ON tender_orchestration_progress;
DROP POLICY IF EXISTS "Users can update own orchestration progress" ON tender_orchestration_progress;
...
DROP TRIGGER IF EXISTS trigger_orchestration_updated_at ON tender_orchestration_progress;
...
SELECT 'tender_orchestration_progress table created successfully' AS status;
