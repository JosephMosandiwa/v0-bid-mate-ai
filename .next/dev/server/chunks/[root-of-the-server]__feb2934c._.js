...
"[project]/app/api/strategist/alerts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const alerts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$engines$2f$strategist$2f$services$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AlertService"].getUserAlerts(user.id, {
            unreadOnly,
            priority,
            limit
        });
        const unreadCount = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$engines$2f$strategist$2f$services$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AlertService"].getUnreadCount(user.id);
        return Response.json({
            alerts,
            unreadCount
        });
...
async function PATCH(request) {
    try {
        ...
        switch(action){
            case "read":
                success = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$engines$2f$strategist$2f$services$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AlertService"].markAsRead(alert_id);
                break;
            case "dismiss":
                success = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$engines$2f$strategist$2f$services$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AlertService"].dismissAlert(alert_id);
                break;
            case "action":
                success = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$engines$2f$strategist$2f$services$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AlertService"].markAsActioned(alert_id);
                break;
            default:
                return Response.json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__feb2934c._.js.map