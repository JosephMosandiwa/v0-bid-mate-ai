...
/* __next_internal_action_entry_do_not_use__ [{"407f88633cdf843df2a278a67732dc7d45cca80b1a":"deleteTenderDocument","40bd4349e69bf94346d5748771c6f820ca4b7a614b":"downloadTenderDocument","40e730bd9e7b9dcaf380994d707fbdbdd248707c70":"getTenderDocuments","40ef9db1733294d72c0e09cb151c53a191e03e0228":"uploadTenderDocument","6075536310bb9f61beb19224fe5c0ce35d37626c2b":"analyzeDocument"},"",""] */ __turbopack_context__.s([
    "analyzeDocument",
    ()=>analyzeDocument,
...
async function getUserTenders() {
    ...
    const { data: scrapedTenders, error: scrapedError } = await supabase.from("user_tenders").select("*").eq("user_id", user.id).order("created_at", {
        ascending: false
    });
    if (scrapedError) {
    ...
    const { data: customTenders, error: customError } = await supabase.from("user_custom_tenders").select("*").eq("user_id", user.id).order("created_at", {
        ascending: false
    });
    if (customError) {
...
async function deleteTender(tenderId, tenderType) {
    ...
    if (!tenderType) {
        ...
        const { data: customTender } = await supabase.from("user_custom_tenders").select("id").eq("id", tenderId).eq("user_id", user.id).single();
        if (customTender) {
            tenderType = "custom";
        } else {
            tenderType = "scraped";
...
async function createCustomTender(tenderData) {
    ...
    try {
        ...
        const { data: customTender, error: customTenderError } = await supabase.from("user_custom_tenders").insert({
            user_id: user.id,
            title: tenderData.title,
            organization: tenderData.organization,
            deadline: tenderData.deadline,
        ...
        if (tenderData.uploadedFile) {
            ...
            try {
                ...
                const { data: insertedDoc, error: docError } = await supabase.from("user_custom_tender_documents").insert(documentData).select().single();
                if (docError) {
        ...
        if (tenderData.analysis) {
            ...
            const { data: insertedAnalysis, error: analysisErr } = await supabase.from("user_custom_tender_analysis").insert(analysisData).select().single();
            if (analysisErr) {
...
async function getDashboardStats() {
    ...
    try {
        ...
        const { count: scrapedCount } = await supabase.from("user_tenders").select("*", {
            count: "exact",
            head: true
        }).eq("user_id", user.id);
        // Get custom tenders count
        const { count: customCount } = await supabase.from("user_custom_tenders").select("*", {
            count: "exact",
            head: true
        }).eq("user_id", user.id);
        const totalTenders = (scrapedCount || 0) + (customCount || 0);
        // Get analyzed tenders (custom tenders with analysis)
        const { count: analyzedCount } = await supabase.from("user_custom_tender_analysis").select("tender_id", {
            count: "exact",
            head: true
        }).in("tender_id", await supabase.from("user_custom_tenders").select("id").eq("user_id", user.id).then((res)=>res.data?.map((t)=>t.id) || []));
        // Get recent activity (last 5 custom tenders)
        const { data: recentCustom } = await supabase.from("user_custom_tenders").select("*").eq("user_id", user.id).order("created_at", {
            ascending: false
        }).limit(3);
        // Get recent scraped tenders
        const { data: recentScraped } = await supabase.from("user_tenders").select("*").eq("user_id", user.id).order("created_at", {
            ascending: false
        }).limit(2);
...
"[project]/.next-internal/server/app/dashboard/tenders/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/document-actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/tender-actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/dashboard/tenders/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/document-actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/tender-actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "4060312bd46fc40ec5491a64b4d4a1575650502b8b",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$tender$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveScrapedTenderToUser"],
    "407f88633cdf843df2a278a67732dc7d45cca80b1a",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$document$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteTenderDocument"],
    "40bd4349e69bf94346d5748771c6f820ca4b7a614b",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$document$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["downloadTenderDocument"],
    "40e730bd9e7b9dcaf380994d707fbdbdd248707c70",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$document$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTenderDocuments"],
    "40ef9db1733294d72c0e09cb151c53a191e03e0228",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$document$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["uploadTenderDocument"],
    "6075536310bb9f61beb19224fe5c0ce35d37626c2b",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$document$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["analyzeDocument"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$dashboard$2f$tenders$2f5b$id$5d2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$document$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$tender$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/dashboard/tenders/[id]/page/actions.js { ACTIONS_MODULE0 => "[project]/app/actions/document-actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/app/actions/tender-actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$document$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/document-actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$tender$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/tender-actions.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__20e9fdd4._.js.map