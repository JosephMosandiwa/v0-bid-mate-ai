...
"[project]/app/api/orchestration/[id]/progress/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        ...
        const orchestrationId = paramsObj.id;
        ...
        const { data: progress, error } = await supabase.from('tender_orchestration_progress').select('*').eq('id', orchestrationId).eq('user_id', user.id).single();
        if (error || !progress) {
            return Response.json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1dc3e9e7._.js.map